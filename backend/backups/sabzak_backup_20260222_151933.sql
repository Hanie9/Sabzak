...
\restrict 2Uj5byodAxvqiV9pr72zDyarYoHBZA3GUxJRNERCyrerfK4Me4fymDHBZUGnRjD
...
1	گل رز	120000.00	پیشنهادی	50	۱۸ تا ۲۵ درجه	گل رز یکی از محبوب‌ترین گل‌های زینتی است؛ با رنگ‌های متنوع و رایحه خوش برای هدیه و تزئین فضای خانه و باغچه بسیار مناسب است. آبیاری منظم و نور غیرمستقیم نیاز دارد.	متوسط
...
4	شمعدانی	95000.00	باغچه‌ای	55	۱۰ تا ۲۵ درجه	شمعدانی با گل‌های رنگارنگ قرمز، صورتی و سفید یکی از بهترین گزینه‌ها برای باغچه و فضای باز است. نور زیاد و آبیاری منظم را دوست دارد و در فصول گرم به خوبی گل می‌دهد.	متوسط
5	دیفن باخیا	110000.00	سمی	70	۱۸ تا ۲۴ درجه	دیفن باخیا گیاه آپارتمانی با برگ‌های پهن و رگه‌دار است. توجه کنید که شیره و برگ‌های آن سمی هستند و باید از دسترس کودکان و حیوانات دور نگه داشته شود. به رطوبت و نور غیرمستقیم نیاز دارد.	متوسط
...
10	آلوئه ورا	90000.00	پیشنهادی	40	۲۰ تا ۲۵ درجه	آلوئه ورا گیاهی دارویی و مفید برای پوست و سوختگی است؛ ژل داخل برگ آن در مصارف خانگی و آرایشی استفاده می‌شود. کم‌آب و نور زیاد را دوست دارد و نگهداری آن ساده است.	متوسط
\.
...
d62922e6-8d8c-435b-b154-aa65d1e8c34d	1	2.5	
\.
...
d62922e6-8d8c-435b-b154-aa65d1e8c34d	حانیه	نباتی	hanie	Hanie@1382	hanienabati@gmail.com	t	2026-02-22 10:24:56.497386
\.
...
\unrestrict 2Uj5byodAxvqiV9pr72zDyarYoHBZA3GUxJRNERCyrerfK4Me4fymDHBZUGnRjD
